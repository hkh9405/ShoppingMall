...
<link type="text/css" rel="stylesheet" href="<%=cp%>/project3/mypage/css/common.css" />
...
<body>
	...
	<div id="wrap">
		<div id="header_top">
			<div id="header">
				<div id="logo">
					<a href="<%=cp%>/shop/main.do"> <img alt=""
						src="<%=cp%>/project3/design/zooyork77/image/logo2.png"
						border="0">
					</a>
				</div>
				<!-- 로고끝 -->
				...
				<div id="cateline">
					<div id="cate">
						...
						<!-- 검색FORM!!!! -->
						<form action="<%=cp%>/shop/search_ok.do" name="searchForm"
							method="post">
							<ul>
								<li class="catein"><a href="<%=cp%>/shop/shopbrand.do">ESPIONAGE</a>
									<!-- COMMUNITY 중분류 시작 -->
									<div class="catebox" style="display: none;">
										<div style="width: 15% !important;">
											...
											<a
												href="<%=cp%>/shop/shopbrand.do?searchKey=pKIND&searchValue=4">OUTER</a>
									...
									<a href="/shop/shopbrand.html?xcode=061&amp;mcode=003&amp;type=Y">SWEAT</a> -->
											<a
												href="<%=cp%>/shop/shopbrand.do?searchKey=pKIND&searchValue=3">SHIRT</a>
											<!-- <a href="/shop/shopbrand.html?xcode=061&amp;mcode=005&amp;type=Y">T-SHIRT</a> -->
											<a
												href="<%=cp%>/shop/shopbrand.do?searchKey=pKIND&searchValue=1">PANTS</a>
											<a
												href="<%=cp%>/shop/shopbrand.do?searchKey=pKIND&searchValue=2">HEADWEAR</a>
											<a
												href="<%=cp%>/shop/shopbrand.do?searchKey=pKIND&searchValue=5">BAG</a>
											<a
												href="<%=cp%>/shop/shopbrand.do?searchKey=pKIND&searchValue=6">ACC</a>
										</div>
									</div></li>

								<li><a href="<%=cp%>/shop/main.do">FEATURES</a></li>
								<li><a href="<%=cp%>/shop/main.do">STYLING</a></li>
								<li><a href="<%=cp%>/shop/main.do">NEWS&nbsp;&nbsp;&nbsp;</a>
								</li>
								<!-- <li> 
							<a href="/shop/page.html?id=3">STORE</a>
								...
								<li>SEARCH <input type="text" name="searchValue"
									style="width: 100px; height: 10px; border: 1px solid;"
									onclick="sendItt();">
								</li>
				...
				<div id="logmenu">
					<ul>
						...
						<li><a
							href="http://www.espionage.co.kr/board/board.html?code=zooyork77_board8">INTERNATIONAL</a></li>
		...
		<div id="contentWrap">
			...
			<div id="content">
				<div id="findIdPwd_result">
					<h1 class="tit-findidpw">주문 완료</h1>
					<p class="sub-tit">
						회원가입 정보는 Info창을 통해 확인하실 수 있습니다.<br>
						신규 회원님의 기본 등급은 Lv.1이며 누적 이용금액에 따라 등급이 올라가게 됩니다. 
					</p>
					<div id="find_Success">
						<dl>
							<dd>
								${sessionScope.customInfo.name }님 안녕하세요.<br/>
								회원님의 주문이 정상적으로 접수되었습니다.<br/>
								감사합니다.<br/>
								총 주문금액 : <%=ptotal %> 원<br/>
								적립금 : <%=getMileage %> 원
							</dd>
					...
					<div class="btn-area">
						<a href="<%=cp%>/shop/myorder.do">
						<img alt="주문조회" src="<%=cp%>/project3/mypage/images/sub_btn_95.gif"></a>
					</div>
				</div>
				<!-- #findIdPwd -->
			</div>
