...
<link type="text/css" rel="stylesheet" href="<%=cp%>/project3/login/css/new_password.css" />
...
<script type="text/javascript"> 
	 ...
	 function sendIt() {
		...
		f.action="<%=cp %>/shop/find_id_ok.do";
		f.submit();
	}	
</script>
				...
				<div id="findIdPwd">
					...
					<form name="form1" method="post" action="" target="loginiframe">
						...
						<div class="find-info">
							<table>
								<tbody>
									<tr class="user-name" height="40">
										<th><div class="tb-l">이&nbsp;&nbsp;름</div></th>
										<td><div class="tb-l">
												<input type="text" id="name" name="name"
													class="MS_input_txt" maxlength="30" title="이름">
											</div></td>
									</tr>
									<tr height="30">
										<th><div class="tb-l">이메일</div></th>
										<td><div class="tb-l">
												<input type="text" id="email" name="email"
													class="MS_input_txt" value="" maxlength="35" title="이메일 주소">
											</div></td>
									</tr>
								</tbody>
							</table>
							...
							<div class="btn-area">
								<a class="info-confirm" href="javascript:sendIt();"><img
									alt="확인"
									src="<%=cp%>/project3/login/img/sub_btn_129.gif"></a>
							</div>
