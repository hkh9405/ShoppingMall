					...
					<div id="faqTable">
						<table summary="분류 제목">
							...
							<tbody>
								<tr>
									<td>
										<div class="tb-center">${dto.fnum }</div>
									</td>
									<td>
										<div class="tb-center">${dto.fcategory }</div>
									</td>
									<td>
										<br/><font size="5"> Q</font>
										<div class="">${dto.fcontent }</div>
										<br/><font size="5"> A</font>
										<div class="">${dto.fcontent2 }</div>
										<br/>
